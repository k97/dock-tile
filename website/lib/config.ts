...
export const siteConfig = {
  ...
  // Download Links
  downloadUrl: "https://github.com/k97/dock-tile/releases/download/v1.7.1/DockTile-1.7.1.dmg",
  releaseNotesUrl: "https://github.com/k97/dock-tile/releases/tag/v1.7.1",
  latestVersion: "1.7.1",
