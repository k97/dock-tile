...
export const siteConfig = {
  ...
  // Download Links
  downloadUrl: "https://github.com/k97/dock-tile/releases/download/v1.4.3/DockTile-1.4.3.dmg",
  releaseNotesUrl: "https://github.com/k97/dock-tile/releases/tag/v1.4.3",
  latestVersion: "1.4.3",
