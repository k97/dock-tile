...
export const siteConfig = {
  ...
  // Download Links
  downloadUrl: "https://github.com/k97/dock-tile/releases/download/v1.8.2/DockTile-1.8.2.dmg",
  releaseNotesUrl: "https://github.com/k97/dock-tile/releases/tag/v1.8.2",
  latestVersion: "1.8.2",
