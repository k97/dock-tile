...
export const siteConfig = {
  ...
  // Download Links
  downloadUrl: "https://github.com/k97/dock-tile/releases/download/v1.3.0/DockTile-1.3.0.dmg",
  releaseNotesUrl: "https://github.com/k97/dock-tile/releases/tag/v1.3.0",
  latestVersion: "1.3.0",
