...
export const siteConfig = {
  ...
  // Download Links
  downloadUrl: "https://github.com/k97/dock-tile/releases/download/v1.8.0/DockTile-1.8.0.dmg",
  releaseNotesUrl: "https://github.com/k97/dock-tile/releases/tag/v1.8.0",
  latestVersion: "1.8.0",
