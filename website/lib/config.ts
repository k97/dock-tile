...
export const siteConfig = {
  ...
  // Download Links
  downloadUrl: "https://github.com/k97/dock-tile/releases/download/v1.4.0/DockTile-1.4.0.dmg",
  releaseNotesUrl: "https://github.com/k97/dock-tile/releases/tag/v1.4.0",
  latestVersion: "1.4.0",
